    ...
    static renderAlerts = (jobs) => {
        ...
        for (const job of jobs){
            ...
            if (daysDiff > 14 && job.status === 'Applied'){
                ul.innerHTML += `<li data-id='${job.id}'>It's been over two weeks since you've applied to ${job.title} at ${job.company}. Reach out to the company to check on status of application!</li>`
